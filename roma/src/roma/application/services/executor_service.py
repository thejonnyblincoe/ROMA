        ...
        **kwargs
        ...
        try:
            ...
            if not executor_result.success:
                raise RuntimeError(f"Executor reported failure: {executor_result.metadata.get('error', 'Unknown error')}")

            # Create execution metrics
            execution_time = executor_result.execution_time or context.execution_metadata.get("execution_time", 0.0)
