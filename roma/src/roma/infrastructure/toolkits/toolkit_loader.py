...
from roma.domain.value_objects import AgentToolkitsConfig, ToolkitConfig
...
class ToolkitLoader:
    ...
    def __init__(self, hydra_config: DictConfig | None = None):
        """
        ...
        try:
            ...
            if hasattr(self._config, "agents") and agent_name in self._config.agents:
                agent_config_dict = self._config.agents[agent_name]
                  ...
                  and agent_name in self._config.profiles.agents):
    ...
    def _lookup_toolkit_config(self, toolkit_name: str) -> ToolkitConfig | None:
        """
    ...
    async def initialize_and_register_toolkits(
        self, toolkit_configs: dict[str, Any], registry: Any
    ) -> None:
        """
        ...
        try:
            ...
            for toolkit_config in default_toolkits:
                try:
                    ...
                    logger.error(
                        f"Failed to register default toolkit {toolkit_config['name']}: {e}"
                    )
