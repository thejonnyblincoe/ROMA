...
class DatabaseConnectionManager:
    ...
    @asynccontextmanager
    async def get_transaction(self) -> Any:
        """
    ...
    async def execute_query(
        self, query: str, *args: Any, connection: Connection | None = None
    ) -> Any:
        """
        Execute a query.
    ...
    async def execute_many(
        self, query: str, args_list: list[Any], connection: Connection | None = None
    ) -> None:
        """
